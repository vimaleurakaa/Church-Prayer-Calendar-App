...
(function ($, window, document, undefined) {
  ...
  var pluginName = "simpleCalendar",
    defaults = {
      ...
      onCalenderLoad: function (currnetDate, event) {},
      //eventsDisplay: function (allevents) {},
    };
  ...
  $.extend(Plugin.prototype, {
    ...
    bindEvents: function () {
      ...
      //Binding day event on Load
      $(plugin.element).ready(function () {
        var date = new Date();
        var allEvent = plugin.eventsDisplay();
        var todaysEvent = plugin.getDateEvents(date);
        plugin.settings.onCalenderLoad(date, todaysEvent, allEvent);
      });
    ...
    displayEvents: function (events) {
      ...
      let allPage = document.querySelector(".myDiv");
      console.log(allPage);
      ...
      events.forEach(function (event) {
        ...
        var $event = $(
          "" +
            '<div style="height:1000px" class="event">' +
    ...
    eventsDisplay: function () {
      var plugin = this;
      //const eventData = plugin.settings.events;
      return plugin.settings.events;
    },
